...
void alternateMergeLinkedList(LinkedList *ll1, LinkedList *ll2)
{
    ListNode* ll1headstorage = ll1->head;
    ListNode* ll2headstorage = ll2->head;

    ListNode* ll1_head = ll1->head; //Pointer to HEAD NODE of LL1
    ListNode* ll2_head = ll2->head; //Pointer to HEAD NODE of LL2

    while (ll1_head != NULL && ll2_head != NULL)
    {
        ListNode* next_ll1; //Traversal Node for LL1
        ListNode* next_ll2; //Traversal Node for LL2
        next_ll1 = ll1_head->next;
        next_ll2 = ll2_head->next;

        ll1_head->next = ll2_head;
        ll2_head->next = next_ll1;
